        ...
        <div class="row">
            <div class="col-lg-4 col-8">
                ...
                <div class="small-box" style="font-weight: bold; background-color: #26BBB0  ">
                    <div class="inner">
                        <p style="font-weight : bold">Total Barang</p>
                    ...
                    <a href="{{ route('tampungan') }}" class="small-box-footer bg-red"> Lihat Detail <i
            ...
            <div class="col-lg-4 col-8">
                ...
                <div class="small-box" style="font-weight: bold; background-color: #26BBB0  ">
                    <div class="inner">
                        <p style="font-weight : bold">Total Peminjam</p>
                        <center> </center>

                        <h3 style="text-align: center;">{{ DB::table('peminjams')->count() }}</h3>
                    </div>
                    <div class="icon">
                        <svg width="90" height="90" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('peminjam-card') }}" class="small-box-footer bg-red"> Lihat Detail <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-4 col-8">
                ...
                <div class="small-box" style="font-weight: bold; background-color: #26BBB0  ">
                    ...
                    <a href="{{ route('barangkeluar-card') }}" class="small-box-footer bg-red">Lihat Detail <i
                            class="fas fa-arrow-circle-right" style="color: dark"></i></a>
                </div>
            </div>
        @stop
