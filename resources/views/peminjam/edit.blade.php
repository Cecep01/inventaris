                ...
                <div class="card-body">
                   <form action="{{route('peminjam.update' , $peminjam->id)}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <select name="jk" value="{{$peminjam->jk}}" id="" class="form-control @error('jk') is-invalid @enderror">
                        ...
                        <div class="form-group">
                           ...
                           <select name="status" value="{{$peminjam->status}}" id="" class="form-control @error('status') is-invalid @enderror">
