            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info text-light">
                        Data Barang Keluar
                        <a href="{{ route('barangkeluar.create') }}" class="btn btn-primary float-right"
                            style="margin-left: 30px"><i class="fas fa-plus-square"> Tambah</i></a>
                        <a href="{{ route('getlaporanKeluar') }}" class="btn btn-warning float-right"><i
                                class="fas fa-print" style="color: white"> Laporan Barang Keluar</i></a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <td>
                                                <form action="{{ route('barangkeluar.destroy', $data->id) }}"
                                                    ...
                                                    <a href="{{ route('barangkeluar.edit', $data->id) }}"
                                                        class="btn btn-info"><i class="fas fa-edit"> Edit</i></a>
